...
public class ConditionsTest implements TestConstants {
  ...
  public void testDataset(TestMetaData testMetaData) throws Exception {
    assertEquals(0, pythonServer.execute(ABS_DIR_PYTHON_BIN, new File(ABS_DIR_PYTHON_SRC, "conditions_temperature.py"),
