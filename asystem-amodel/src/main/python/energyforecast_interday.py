...
def pipeline():
    ...
    print("Session started:\n  Model version: [1005]\n  "
          "ASystem version: [10.000.0045-SNAPSHOT]\n  Local path: [{}]\n  Data URI: [{}]\n  Model URI: [{}]\n"
    ...
    training_uri = nearest(hdfs_make_qualified(
        ...
        "amodel_version=10.000.0045-SNAPSHOT/amodel_model=1005"))
    ...
    model_file = '/model/pickle/joblib/none/amodel_version=10.000.0045-SNAPSHOT' \
