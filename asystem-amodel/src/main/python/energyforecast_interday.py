...
def execute(model=None, features=None,
    ...
    if labels:
        ...
        features_engineered_renamed['rain_mm'] = \
          features_engineered_renamed['rain_mm'].apply(lambda x: float(mp.power(x*2,2)))
...
def pipeline():
    ...
    print("Session started:\n  Model version: [1005]\n  "
          "ASystem version: [10.000.0096-SNAPSHOT]\n  Local path: [{}]\n  "
          "Data URI: [{}]\n  Model URI: [{}]\n"
    ...
    training_uri = nearest(qualify(remote_data_path + "/train/text/csv/none/" +
                                   "amodel_version=10.000.0096-SNAPSHOT/amodel_model=1005"))
    ...
    model_file = '/model/pickle/joblib/none/amodel_version=10.000.0096-SNAPSHOT' \
