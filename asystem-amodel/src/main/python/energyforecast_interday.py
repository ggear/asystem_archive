...
def pipeline():
    ...
    print("Session started:\n  Model version: [1007]\n  "
          "ASystem version: [10.000.0120-SNAPSHOT]\n  Local path: [{}]\n  "
          "Data URI: [{}]\n  Model URI: [{}]\n"
    ...
    training_uri = nearest(qualify(remote_data_path + "/train/text/csv/none/" +
                                   "amodel_version=10.000.0120-SNAPSHOT/amodel_model=1007"))
    ...
    model_file = '/model/pickle/joblib/none/amodel_version=10.000.0120-SNAPSHOT' \
