...
df = pd.read_csv("../../test/resources/data/amodel/energy/pristine/training/canonical/txt/csv/none/amodel/1000/engery.csv")
...
# GG: comment out so we can use outside jupyter
# get_ipython().magic(u'matplotlib inline')
# get_ipython().magic(u"config InlineBackend.figure_formats = {'png', 'retina'}")
...
# GG: Update for pandas
pd.DataFrame.std(df2)
