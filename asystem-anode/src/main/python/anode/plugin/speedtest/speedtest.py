        ...
        try:
            for target in targets or []:
                if target in SPEEDTEST_ID_METRIC:
                    if packet_type != "latency":
                        self.datum_push(
                            "internet__speed__upload_D" + SPEEDTEST_ID_METRIC[target],
                            "current", "point",
                            throughput_upload,
                            "KB_P2Fs",
                            10,
                        ...
                        self.datum_push(
                            "internet__speed__download_D" + SPEEDTEST_ID_METRIC[target],
                            "current", "point",
                            throughput_download,
                            "MB_P2Fs",
                            100,
                    ...
                    if packet_type != "throughput":
                        self.datum_push(
                            "internet__speed__ping_D" + SPEEDTEST_ID_METRIC[target],
                            "current", "point",
                            latency_ping,
                            "ms",
                            100,
