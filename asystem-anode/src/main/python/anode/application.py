...
APP_MODEL_ENERGYFORECAST_VERSION = _APP_MODEL_CONF["MODEL_ENERGYFORECAST_VERSION"]
APP_MODEL_ENERGYFORECAST_INTRADAY_VERSION = _APP_MODEL_CONF["MODEL_ENERGYFORECAST_INTRADAY_VERSION"]
