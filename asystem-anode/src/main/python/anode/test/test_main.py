...
class ANodeTest(TestCase):
    ...
    def test_good_plots(self):
        ...
        for parameters in [
            ...
            ("&start=" + str(last_timestamp - (60 * 60 * 24 * 6 + 60 * 60 * 4)) + "&period=3600&method=max&fill=linear"),
            ("&start=" + str(last_timestamp - (60 * 60 * 24 * 6 + 60 * 60 * 8)) + "&period=3600&method=max&fill=linear"),
            ("&start=" + str(last_timestamp - (60 * 60 * 24 * 6 + 60 * 60 * 16)) + "&period=3600&method=max&fill=linear"),
            ("&start=" + str(last_timestamp - (60 * 60 * 24 * 6 + 60 * 60 * 24)) + "&period=3600&method=max&fill=linear"),
            "&partitions=7&period=3600&method=max&fill=linear",
            ("&start=" + str(last_timestamp - (60 * 60 * 24 * 13 + 60 * 60 * 4)) + "&period=7200&method=max&fill=linear"),
            ("&start=" + str(last_timestamp - (60 * 60 * 24 * 13 + 60 * 60 * 8)) + "&period=7200&method=max&fill=linear"),
            ("&start=" + str(last_timestamp - (60 * 60 * 24 * 13 + 60 * 60 * 16)) + "&period=7200&method=max&fill=linear"),
            ("&start=" + str(last_timestamp - (60 * 60 * 24 * 13 + 60 * 60 * 24)) + "&period=7200&method=max&fill=linear"),
            "&period=7200&method=max&fill=linear"
        ]:
            self.assertRest(0,
                            anode,
